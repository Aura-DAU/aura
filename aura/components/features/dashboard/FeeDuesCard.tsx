 ...
 * Backend parser (Parth) is 🟡 Partial; card degrades gracefully until it ships.
 */
  ...
  return (
    <div className="rounded-2xl border border-theme-gray-light bg-theme-gray p-5">
      <div className="mb-4 flex items-center gap-2">
        <IndianRupee className="size-4 text-theme-red shrink-0" />
      ...
      {hasEcampusIssue ? (
        ...
        // Backend parser not yet complete — graceful fallback
        <p className="text-xs text-neutral-500">
