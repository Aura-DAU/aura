...
export default function SettingsHubPage() {
  ...
  return (
    <div className="relative min-h-screen bg-theme-black px-4 py-10 sm:px-6 lg:px-8 text-neutral-100">
      ...
      <div className="relative z-10 mx-auto w-full max-w-xl md:max-w-3xl lg:max-w-4xl">
        ...
        <div className="mb-8">
          <h1 className="flex items-center gap-2.5 text-2xl font-black tracking-tight text-neutral-100 sm:text-3xl lg:text-4xl">
            <Settings className="size-7 sm:size-8 text-theme-yellow" />
            Settings
          </h1>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {isStudent ? (
            ...
            >
              <span className="inline-flex size-10 sm:size-12 shrink-0 items-center justify-center rounded-xl bg-theme-yellow/10 text-theme-yellow">
                <CalendarCheck2 className="size-5 sm:size-6" />
              </span>
              <span className="min-w-0">
                <span className="block text-sm sm:text-base font-semibold text-neutral-100">
                  Connect Google Calendar
                </span>
                <span className="mt-1 block text-xs sm:text-sm leading-relaxed text-neutral-400">
        ...
        <div className="mt-6">
          <Link
            href="/dashboard"
            className="flex items-center justify-center gap-2 rounded-xl border border-theme-gray-light bg-theme-black/30 px-4 py-3 text-sm font-medium text-neutral-300 transition-colors hover:border-theme-gray-lighter hover:text-neutral-100 md:w-max md:px-8"
          >
            Go to Dashboard
          </Link>
        </div>
