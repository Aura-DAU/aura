...
import { QueryTraceDashboard } from "@/components/features/dashboard/QueryTraceDashboard"
...
export default function AdminBindingsClient() {
  const [activeTab, setActiveTab] = useState<"traces" | "access" | "latency">("traces")
  ...
  return (
    <div className="min-h-screen bg-theme-black text-neutral-100 px-4 py-12 md:px-8 font-sans">
      <div className="mx-auto max-w-6xl animate-in fade-in duration-200 text-left">
        {/* Header */}
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-400 mt-0.5 font-sans">
              Real-time query telemetry, role bindings, user access, and system latency metrics.
            </p>
          </div>
        </div>

        {/* Navigation Tabs */}
        <div className="mb-6 flex border-b border-theme-gray-light">
          <button
          ...
          >
            ...
            System Latency Boxplots
          </button>
        </div>

        {activeTab === "traces" && <QueryTraceDashboard />}
