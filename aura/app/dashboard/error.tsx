...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-[450px] w-full flex-col items-center justify-center p-8 text-center">
      <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/60 p-6 backdrop-blur-md shadow-xl">
        ...
        <h2 className="mb-2 text-lg font-semibold text-white">Failed to load dashboard</h2>
