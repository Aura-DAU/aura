...
Evaluates the Aura RAG bot against questions derived from the Faculty Cluster diagram.
Handles Groq model rate limits and token exhaustion by switching models automatically.
...
def run_evaluation(api_url: str, csv_path: str, output_path: str) -> None:
    ...
    output = {
        "meta": {
            ...
            "cluster_image": "WhatsApp Image 2026-07-02 at 17.48.09.jpeg",
            "started_at": start_ts,
