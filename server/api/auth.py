...
class Identity:
    ...
    current_lab_group: Optional[str] = None
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "current_lab_group": self.current_lab_group,
...
def require_identity(
    ...
    return Identity(
        ...
        current_lab_group=claims.get("currentLabGroup") if isinstance(claims.get("currentLabGroup"), str) else None,
