...
# It628 System Programming (IT628)

## Overview

This document presents the detailed policy and syllabus structure for the course It628 System Programming (IT628). It includes details on course objectives, credits, prerequisites, syllabus content, evaluation schemes, and contact information where available.
...
| Inter-process communication: pipes, non-blocking reads and writes, shared |  |  |  |
| memory. |  |  |  |
| Threads: differences between processes and threads, c |  |  |  |
...
- **Course Code:** IT628
- **Course Title:** It628 System Programming
...
| Resource | Type | Link |
|---|---|---|
| IT628_System Programming.pdf | PDF | [Download IT628_System Programming.pdf](https://intranet.daiict.ac.in/academics/IT628_System Programming.pdf) |
