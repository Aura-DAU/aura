...
This document presents the detailed policy and syllabus structure for the course Applied Forecasting Methods (SC475). It includes details on course objectives, credits, prerequisites, syllabus content, evaluation schemes, and contact information where available.
...
Total Credits: 4 |
| 3. Course Code | SC475 |
| 4. Program/Semester | B.Tech. (ICT) (VI and VIII Semester) / M.Tech. (ML) (II Semester) Winter
Semester |
| 5. Category | Technical Elective |
| 6. Prerequisite
courses | Machine Learning, Basic Programming. |
| 7. Foundation for | UG (VI Semester) / Industry Applications that involves forecasting tasks |
| 8. Abstract Content | This course aims to develop a systematic understanding of the forecasting
...
| Text Book and
Materials | (i) Hyndman, R.J., & Athanasopoulos, G. (2018) Forecasting:
...
(iii) Koenker, R., Chernozhukov, V., He, X., & Peng, L. (Eds.).
(2017). Handbook of Quantile Regression (1st ed.). Chapman
...
| Introduction to
Forecasting Methods | Application of forecasting in different verticals like energy,
finance, environment and health. Motivation, Definition,
objectives and approaches in Forecasting, | 2 |
| Regression from ML
perspective | Linear regression models, Least Square Methods, Non-linear
regression models, Kernel Regression, Gradient Descent
Methods, Evaluation Metrics. | 6 |
| Quantile Regression &
Uncertainty
Quantification | Quantile Regression model, Pinball loss function, Quantile
Regression with Kernel Machine, Quantile Regression
Neural Network, Prediction Interval Estimation, Evaluation
Metrics, Uncertainty Modeling with Kernel Machine and
Neural Network. | 12 |
| Statistical Time-series
Models | Introduction to Time Series Forecasting , AR, ARMA and
ARIMA models. | 8 |
| Time Series
Forecasting with Deep
Learning | Time Series Forecasting with Recurrent Neural Network
(RNN), Gated Recurrent Unit (GRU), Long Short Term
Memory (LSTM) , Deep Auto Regressive (Deep AR)
model, Time GPT model. | 8 |
| Probabilistic
Forecasting | Probabilistic Forecasting in Neural Network, RNN, LSTM
and Deep AR models. | 4 |
| Outcomes and
Objectives | - Systematically develop a deep understanding of the main principles of
forecasting.
- Develop the machine learning perspective for forecasting and uncertainty
modeling.
- Develop the understanding of statistical and modern time series models for
point and probabilistic forecasting tasks.
...
| Comments | Lab – The Lab classes would be dedicated for systematic implementation of
...
| Resource | Type | Link |
|---|---|---|
| IT402 _Applied_Forecasting_Methods_Winter_2026 - Pritam Anand.pdf | PDF | [Download IT402 _Applied_Forecasting_Methods_Winter_2026 - Pritam Anand.pdf](https://intranet.daiict.ac.in/academics/IT402 _Applied_Forecasting_Methods_Winter_2026 - Pritam Anand.pdf) |
