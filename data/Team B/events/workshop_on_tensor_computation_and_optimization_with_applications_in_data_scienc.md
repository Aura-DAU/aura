...
The attendees will learn how to operate with tensors to handle multi-dimensional data sets and learn some new optimization techniques to solve problems evolved in Data Science.

The distinguished speakers for the workshop include :
...
The interested participants can register on or before November 18, 2025, with the link given below. Please note that there is no registration fee.
