...
This document presents the detailed policy and syllabus structure for the course Electronic Design Lab (PREREQUISITES). It includes details on course objectives, credits, prerequisites, syllabus content, evaluation schemes, and contact information where available.
...
Course Objective: This module equips the students to learn different CAD, EDA tools & HDL for 
hardware and be conversant with the measuring instruments.  
 
 
 
Course Outcome 
 
Having successfully completed this module the student will be able to use function generators, 
oscilloscopes and complex devices such as logic analysers, spectrum analysers, understand data 
sheets, debug HW and SW systems, design simple digital ICs and perform synthesis of simple 
