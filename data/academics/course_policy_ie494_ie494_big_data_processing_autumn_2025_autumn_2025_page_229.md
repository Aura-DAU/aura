...
# IE494, Big Data Processing (Autumn’2025) (IE494)

## Overview

This document presents the detailed policy and syllabus structure for the course IE494, Big Data Processing (Autumn’2025) (IE494). It includes details on course objectives, credits, prerequisites, syllabus content, evaluation schemes, and contact information where available.
...
Model Programming, Spark-SQL: infrastructure and programming | 4 |
...
modern distributed databases. Eventual Consistency. | 3 |
| 8. | One of column family database (Big Table/HBase/Cassandra): Data Model
and Programming | 4 |
| 9. | Column Oriented Storage and Column Oriented Databases: Motivation and
...
- **Course Code:** IE494
- **Course Title:** IE494, Big Data Processing (Autumn’2025)
