# Timetable — B.Tech MNC — 3rd Year (Semester 5) (Autumn 2026-27)
...
Note: the source timetable lists 'MC314' and 'HM116' as two separate rows at the exact same day/time/faculty/room (SMD, CEP-102) — these appear to be the same Principles of Economics class recorded under both a branch-specific code and the common code, rather than two distinct courses. Listed once below.
