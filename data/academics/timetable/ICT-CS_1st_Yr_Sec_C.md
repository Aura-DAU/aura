...
# Timetable — B.Tech ICT-CS — 1st Year, Section C (Autumn 2026-27)

Source: derived from the official DAU Autumn 2026-27 combined lecture timetable, filtered by course code and section.

## Program Core (PC1) — ICT-CS

Note: The source timetable has no PC1 row explicitly labeled "ICT-CS." This is assigned to faculty SB2, Rm CEP-108 as a best guess — verify against registrar's faculty list.
...
Note: IC sections (A–D) mix students from all branches for room-capacity reasons. Section C timetable below.
