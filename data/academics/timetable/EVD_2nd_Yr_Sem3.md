...
# Timetable — B.Tech EVD — 2nd Year (Semester 3) (Autumn 2026-27)
...
Note: Science, Technology and Society (HM216) is a large lecture shared across all four branches (EVD/MNC/ICT/ICT-CS), split into two lab-sized sections (Sec A / Sec B) purely for room capacity — not a branch split. Both sections are listed below; EVD students attend whichever section they're registered in.
