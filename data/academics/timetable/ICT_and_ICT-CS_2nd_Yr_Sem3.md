# Timetable — B.Tech ICT & ICT-CS — 2nd Year (Semester 3) (Autumn 2026-27)
...
Note: In Semester 3, ICT and ICT-CS follow an identical curriculum (per the official course-structure sheets you shared, ICT-CS only diverges starting Semester 4 with 'Introduction to Computational Physics'). The timetable data has no course code that distinguishes the two branches this semester — all of Linear Algebra (SC223), Computer Systems Programming (IT227), Signals and Systems (CT204), Design and Analysis of Algorithms (IT216), and Science/Tech/Society (HM216) are combined ICT+ICT-CS classes split into Sec A / Sec B purely for room capacity. Both sections are listed below; ICT and ICT-CS students are mixed within each.
...
| Wednesday | 12:00-12:50 | CT204 (Sec A) — Signals and Systems | RLD | CEP-110 |
| Wednesday | 12:00-12:50 | IT216 (Sec A) — Design and Analysis of Algorithms | PB | LT-2 |
| Wednesday | 12:00-12:50 | IT216 (Sec B) — Design and Analysis of Algorithms | RM | LT-3 |
| Thursday | 12:00-12:50 | SC223 (Sec A) — Linear Algebra | AKT | CEP-102 |
