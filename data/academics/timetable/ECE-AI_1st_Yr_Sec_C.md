...
# Timetable — B.Tech ECE-AI — 1st Year, Section C (Autumn 2026-27)

Source: derived from the official DAU Autumn 2026-27 combined lecture timetable, filtered by course code and section.

Note: The source timetable has no PC1 row explicitly labeled "ECE-AI." This is assigned to faculty AB, Rm CEP-206 as a best guess — verify against registrar's faculty list.
