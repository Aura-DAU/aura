# Timetable — B.Tech ECE-AI — 1st Year (Autumn 2026-27)
...
**Flag — please verify:** the source timetable has no PC1 row explicitly labeled "ECE-AI" either. I've assigned the second unlabeled PC1 session (faculty AB, Rm CEP-206) to ECE-AI as a best guess. If AB doesn't match an ECE/AI faculty member you recognize, this may be swapped with the ICT-CS file above — check faculty initials and swap if needed.

## Program Core (PC1) — ECE-AI
