---
title: "M.Des. IUx D sem-1 Course file (1)"
url: "https://intranet.daiict.ac.in/~daiict_nt01/Academic/Courses/Course_Files_Autumn_2025_26/Autumn_2025_26_Individual_Course_Files/M.Des.%20IUxD%20sem-1%20Course%20file%20%281%29.pdf"
category: "Academics"
...
# M.Des. IUx D sem-1 Course file (1) (UNKNOWN)

## Overview

This document presents the detailed policy and syllabus structure for the course M.Des. IUx D sem-1 Course file (1) (UNKNOWN). It includes details on course objectives, credits, prerequisites, syllabus content, evaluation schemes, and contact information where available.

## Main Content

| Course Title | M.Des. IUx D sem-1 Course file (1) | | |
|---|---|---|---|
| Course Code | UNKNOWN | Credit Structure | 2-0-2-3 |
| Category |  | Semester | 1st Semester, Autumn 2025-26 |
| Program | Mdes (IUxD | | |
| Prerequisites |  | | |
| Course Objectives/ Brief Course Description |  | | |
| Evaluation/ Grading Policy |  | | |
| Course Materials/ References | Masters of Design in Intelligent User Experience Design – Mdes (IUxD) Semester -1 MI601: Orientation to Intelligent User-Experience Design Credit structure: 2-0-2-3 Content: This course offers an insightful introduction to the Master of Design in Intelligent User Experience Design-IUxD. It delves into the rich history of digital design, tracing its evolution and highlighting pivotal practices that have shaped the field. Special emphasis is placed on the current landscape of the design industry in India & abroad, providing students with a comprehensive understanding of potential professional av | | |
...
| Resource | Type | Link |
|---|---|---|
| M.Des. IUxD sem-1 Course file (1).pdf | PDF | [Download M.Des. IUxD sem-1 Course file (1).pdf](https://intranet.daiict.ac.in/~daiict_nt01/Academic/Courses/Course_Files_Autumn_2025_26/Autumn_2025_26_Individual_Course_Files/M.Des.%20IUxD%20sem-1%20Course%20file%20%281%29.pdf) |
