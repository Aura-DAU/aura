...
The **Add/Drop window** is a short period after the start of classes during which students may add new courses or drop registered ones without academic penalty. This window is distinct from the semester registration period.
...
Course additions and drops are processed through the **eCampus / ERP Portal**:
- [eCampus Portal](https://ecampus.daiict.ac.in)
