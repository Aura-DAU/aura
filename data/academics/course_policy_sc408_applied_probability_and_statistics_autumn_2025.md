---
title: "SC408 Applied Probability and Statistics 1st Semester, Autumn 2025-26""
...
| Generating functions and applications | Different types of generating functions, branching processes, convergence and asymptotics, large devi- ations | 6 |
| Martingales | Martingales, sub and supermartingales, optional stopping, random walk, wald’s identity | 6 |
| Stochastic processes | Brownian motion – definition and properties, Donsker’s theorem, Reflection principle, Black Sc- holes Model, Poisson process – definition and prop- erties, superposition, thinning, poisson process in higher dimensions | 6 |
| Statistical inference | Method of moments, Maximum likelihood estima- tion, Bayesian inference, Sampling distributions, Confidenceintervals,nonparametricdensityestima- tion | 8 |
| Regression and machine learning | Supervised and unsupervised learning algorithms, kNN regression and classification, k-means cluster- ing, linear regression | 4 |
...
This course is offered as part of the MTech ICT in 1st Semester, Autumn 2025-26.
