...
url: "https://www.daiict.ac.in/faculty/abhishek-gupta"
category: "Faculty"
...
* **PhD in Electrical and Computer Engineering**, Toronto Metropolitan University, Canada
* **MS in Electrical and Computer Engineering**, Toronto Metropolitan University, Canada
...
Abhishek Gupta's research combines Communication theory, Statistical learning, Vision systems, Applied AI, and Network optimization. This makes him one of the most interdisciplinary faculty members in the ICT school.

### Theme 1: Wireless + AI
Applying machine learning models to data collected from traditional wireless networks to achieve better coverage, better resource allocation, and overall better performance. This area is increasingly important for 5G, 6G, intelligent networks, and Edge AI.

### Theme 2: Stochastic Geometry
A mathematically intensive area used to analyze cellular networks, explaining mathematical modeling using probabilistic spatial models. Relevant for students interested in probability, wireless, and mathematical modeling.

### Theme 3: Computer Vision for Autonomous Systems
Focuses on machine vision, scene perception, vehicle sensing, and ML-based recognition with applications in self-driving cars, smart transportation, and robotics.
...
**Excellent Match For:** Wireless Communications, Signal Processing, Networking, AI for Communication Systems, Intelligent Transportation, Computer Vision.
**Moderate Match For:** Machine Learning, Data Science.
*(Note: NLP, HCI, and Software Engineering are better aligned with other faculty).*

### Likely Student Project Ideas
* **B.Tech Level:** WiFi traffic prediction, ML-based network monitoring, Vehicle detection systems, Image classification.
* **M.Tech Level:** AI for wireless resource allocation, 5G optimization, Network anomaly detection, Vision-based autonomous navigation.
