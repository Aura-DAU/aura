...
* Question paper administration
* Stationery distribution and management
* Invigilation arrangements of the exams
* Surprise checks and Handling Malpractice Cases
* Attendance and record keeping
* Strong Room Operations
* Data Management
* Assistance and guidance to students for special needs.
* Publishing results
* Issuing mark sheets, transcripts, and certificates.

### Important Announcements

#### **Stay updated with the latest notifications regarding examination dates, form submissions, and results**.
...
**For any queries related to examinations, feel free to reach out to us**:

### Examination Office, DAU

#### Phone: 079-68261574 Email: coe\_office[at]dau[dot]ac[dot]in
...
Email: controller_examination[at]dau[dot]ac[dot]in

---

### Dinesh Prajapati

Position: Jt. Controller of Examination

Email: jt.controller_examination[at]dau[dot]ac[dot]in

---

### Mahendrasinh Dabhi

Position: Senior Executive - Examination

Email: coe_office[at]dau[dot]ac[dot]in

---

### Jainik Patel

Position: Sr. Executive - Exam & Student Support
...
- [Exam Seat Portal - Know your exam hall details online](https://ssrs.daiict.ac.in/Exam_Seat_Arrangment/)
- [Apply for Academic Records, Grade Card, CGR etc .](https://documents.daiict.ac.in/student/login)


## Downloadable Resources

- [Upcoming Examinations: Winter 2025-26: End Semester Examination](https://www.daiict.ac.in/sites/default/files/other-files/Schedule-for_Winter_2025-26_End_Semester_Exams_2026.pdf) (PDF)
- [Examination Rules for Students](https://www.daiict.ac.in/sites/default/files/other-files/Examination_Rules_for_Students.pdf) (PDF)
