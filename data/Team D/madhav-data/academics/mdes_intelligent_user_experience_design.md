...
IUxD specialization emphasizes design-driven innovation in conjunction with broad understanding of underlying principle of relevant programming languages and ‘intelligent’ technologies. Students gain an understanding of AI-powered design principles, predictive and generative technologies, and the role of data in crafting meaningful user experiences. Through hands-on projects, industry collaborations, and research-based learning, they develop expertise in designing smart products and services across diverse sectors such as healthcare, education, urban systems, finance, and entertainment.
...
At the end of the two-year specialization, graduates will be crafting inclusive, accessible, and human-centered designs through research and user behavior analytics. The graduates will be able to collaborate with engineers and software specialists to integrate hardware, software, and design, to develop multi-device ecosystems. As design technologists, they will bridge technology and creativity, leveraging AI, AR/MR/XR, and IoT to create adaptive, intelligent experiences. Equipped with technical fluency and design expertise, they will contribute to interactive experiences across industries, ensuring innovation remains responsible and impactful.

### Curriculum

The two-year program of study leading to M.Des. degree is divided into four semesters along with a summer break between the first and second years.
...
Fundamentals of Design for IUxD | 3-0-4-**5**  
Elements of Design for IUxD | 2-0-4-**4**  
Intelligent Technology: An-introduction | 2-0-4-**4**  
...
Design Research Methods | 2-0-2-**3**  
AI & Interaction Intelligence | 2-0-4-**4**  
Intelligent Design Decisions | 2-0-4-**4**  
Human Factors (Physical and Cognitive Ergonomics) in Interaction Design | 2-0-2-**3**  
User Interface Design | 2-0-4-**4**  
  
Semester III

Course Name | Credit  
---|---  
AR & XR for Designers | 1-0-4-**3**  
Interaction Design | 3-0-4-**5**  
Phygital Experience Design | 3-0-4-**5**  
Immersive Experience Design | 3-0-4-**5**  
...
### Pedagogical Principles
  ...
  * The courses transit from foundational courses in the first semester to advanced specialized courses in the third semester.
  * The first semester foundation modules are meant introduce students to the fundamentals of design principles and design skills for IUxD.
  * Integration of theory and practice will be stressed throughout the specialization.
...
Human Factors in Interaction Design **|** 2-0-2-**3**
...
The teaching approach for each course comprises a combination of lectures, seminars, studio, and practical sessions. The lectures would mainly focus on basic ideas and concepts, which would be substantiated and discussed through seminars, engaging students in active participation in project work. Lecture sequences in a course may be conducted by multiple faculties, and the seminars would be designed to provide a bridge between the lectures and the studio and practical sessions. Emphasis would be that students learn how to learn, what is needed, and when it is needed; in an environment of ever-changing needs and technologies. For each course, the emphasis would be on research and project work that utilizes the methods and ideas learned from other courses. The final student project worth 18 credits must be completed in the fourth semester.

### Opportunities After M.Des (IUXD)

Intelligent User Experience Design is a rapidly evolving field with applications across multiple industries. Graduates can contribute to Education by designing interactive learning tools and AR/VR platforms. Healthcare industry offers roles in telemedicine, wearables, and patient-centric designs. The Automotive sector demands intuitive dashboards and autonomous vehicle interfaces, while Retail & E-commerce benefit from smart shopping and conversational AI. Career paths include UX & HCI Researcher, UX Auditor, Mobile & Web Designer, AR/XR/MR Interaction Designer, IoT Product Designer, Phygital Retail Designer, and Social Intelligent Systems Designer and as entrepreneurs.
...
| Resource | Type |
| --- | --- |
| [here](https://www.daiict.ac.in/sites/default/files/other-files/MDes_IUxD_2026.pdf) | PDF |
