---
title: "BS-MS in Data Science & Artificial Intellifence"
...
---|---|---  
**BS-MS Dual Degree in  
Data Science and Artificial Intelligence** | **3 Years: Bachelor of Science (B.Sc.)  
4 Years: Bachelor of Science Honours (B.S.)  
5 Years: Master of Science (M.S) or M.S. by Research** | **Full Time**  
...
Many existing undergraduate programs focus either on traditional computer science or introductory analytics. Few offer an integrated pathway that brings together:
...
This program integrates both, preparing students to move from data understanding to intelligent system creation.
...
This program is designed for students who:
  ...
  * **Prefer a seamless five-year academic pathway** , progressing from strong foundations to advanced specialization and thesis-level work within a single integrated program.

The program is ideal for students who aim to develop both intellectual depth and practical capability, preparing them for impactful careers in advanced data science and artificial intelligence.

Program Overview

The BS–MS Dual Degree in Data Science & Artificial Intelligence is a comprehensive five-year program that builds expertise across the full spectrum of data-driven intelligence: from foundational mathematics to advanced autonomous AI systems.

### Progressive Learning Path

The program follows a carefully structured year-wise progression that advances students from foundational understanding to independent innovation:
...
**Technology does not exist in isolation. The program integrates courses in** :
...
Strong grounding in programming, statistics, data science, and core machine learning.
  * **After 4 Years – BS (Bachelor of Science – Honours)**  
Advanced specialization in data engineering, AI systems, and applied analytics.
  * **After 5 Years – MS (Master of Science / Master of Science by Research)**  
...
### Program Credit Framework

The BS–MS Dual Degree in Data Science & Artificial Intelligence is a 200-credit, five-year program designed to balance theoretical depth, practical capability, and experiential learning.
...
The core curriculum ensures strong scientific and engineering foundations:
  ...
  * **Computing – 17.5%**  
Programming, data structures, algorithms, systems, and scalable computing.
  * **Data Science & AI – 16%**  
Statistical modeling, machine learning, deep learning, and AI systems.
  * **Mathematics – 14%**  
Linear algebra, calculus, probability, optimization, and analytical methods.
  * **Humanities & Social Sciences – 7.5%**  
...
Students progressively tailor their academic pathway through:
  ...
  * **Program Electives – 15.5%**  
Advanced AI, data engineering, autonomous systems, and domain-specific analytics.
  * **Open Electives – 4.5%**  
Courses from other disciplines to broaden intellectual exposure.
  * **Online Open Electives – 4.5%**  
Curated external courses aligned with emerging technologies.
  * **Projects, Seminars & Internships – 18%**  
Industry immersion, research engagement, and applied AI system design.
...
### Program Elective Basket Structure
...
Advanced mathematical, statistical, and algorithmic foundations for designing intelligent models and learning systems.
  * **Systems & Engineering for AI**  
Scalable, reliable, and production-ready AI system design, deployment, and infrastructure.
  * **Domains & Applied Analytics**  
Application of data science and AI techniques to real-world sectoral challenges.
  * **Ethics, Governance & Emerging AI**  
Responsible AI, policy, interpretability, and emerging trends in trustworthy intelligent systems.

This elective basket framework supports individualized learning pathways while maintaining alignment with the program’s broader objectives. It ensures that graduates develop technical mastery alongside contextual awareness and ethical responsibility.
...
Sem 1 | Program Core (Computing) |  Programming in Python | 4 (3-0-2)  
...
Sem 2 |  Program Core (HSS) | The Art of Telling | 3 (3-0-0)  
| **19 (15-2-4)**  
  
Year II: Modeling and Systems
...
Year III: Machine Learning & Deployment
...
\- Manufacturing & Industrial Systems Analytics  
\- Finance & Econometrics  
\- Environment, Energy, and Sustainability Analytics  
\- Cybersecurity Analytics  
Sem 7 | Open Elective 1 | \- Data and Culture  
\- Indian Knowledge System  
\- or any other 3 Credit Course | 3 (3-0-0)  
...
\- AI Systems: Thinking beyond Models  
Sem 8 | Program Elective 7 | **Domain & Applied Analytics** | 4 (3-0-2)  
\- Business Process and Automation Analytics  
\- Marketing & Consumer Analytics  
\- Healthcare Analytics  
\- Agri Analytics  
Sem 8 | Open Elective 2 | \- Technology Entrepreneurship and Innovation  
...
Sem 9 | Open Elective 3 | \- Startup Strategy and Growth Management  
...
The program provides strong preparation for advanced research pathways. Graduates may:
...
The program encourages responsible and sustainable technology entrepreneurship.
...
With its interdisciplinary and research-oriented foundation, the program also prepares graduates for:
...
_**The Institute reserves the right to interpret and apply these rules in case of ambiguity. Decisions of the Admission Committee shall be final and binding.**_
...
Hostel Rent (including Food and Transportation)  
For Off Campus Hostel within short distance | Rs. 2,00,000/- per year for double occupancy  
Rs. 1,60,000/- per year for triple occupancy  
One-time Rs. 15,000/ refundable security deposit,  
...
A BS–MS dual degree program is an integrated five-year academic pathway that combines undergraduate and postgraduate study in a single structured curriculum. Students progress from foundational coursework to advanced specialisation and graduate-level study without needing to apply separately for a master’s degree.

### 2\. How is a dual degree different from a traditional B.Tech. or B.Sc. program?

Dual degree programs are designed to provide deeper academic specialisation and advanced training. Students move beyond undergraduate foundations to graduate-level courses, research, and industry projects within the same program, preparing them for leadership roles in technology, research, and innovation.

### 3\. What degrees are awarded upon completion?

Students receive both a **Bachelor of Science – Honours (BS) degree and a Master of Science (MS) degree** upon successful completion of the five-year program.

### 4\. Are there exit options during the program?

Yes. In line with the National Education Policy (NEP 2020), the program offers structured exit options:
...
The program is **five years (ten semesters)** and follows a progressive learning structure that moves from foundational concepts to advanced specialisation and research or industry engagement.
...
The program also includes electives, projects, internships, and research opportunities.

### 7\. Are internships and projects part of the program?
...
### 8\. What career opportunities are available after completing the program?
...
### 9\. Can students pursue higher studies after completing the program?

Yes. The integrated M.S. degree provides strong preparation for **Ph.D. programs and advanced research opportunities** at leading universities and research institutions worldwide.

### 10\. Is the program suitable for students interested in research?
...
Yes. Since the program involves advanced topics in data science, computing, and artificial intelligence, **a strong background in mathematics is essential**.
...
- [BS-MS Scholarships at DAU](https://www.daiict.ac.in/bs-ms-scholarships-dau)
- [BS-MS Institute Fellowships at DAU](https://www.daiict.ac.in/bs-ms-institute-fellowships-dau)
