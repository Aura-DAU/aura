# Timetable — B.Tech CS-AI — 1st Year, Section C (Autumn 2026-27)

Source: derived from the official DAU Autumn 2026-27 combined lecture timetable, filtered by course code and section.

Note: CS-AI is a separate DAU program (B.Tech Computer Science & AI), not the same as the ICT-CS honors/specialization track.

## Program Core (PC1) — CS-AI
