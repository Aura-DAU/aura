---
title: "CT204 Signals and Systems Autumn 2025-26"
...
| **Semester Offered** | Autumn 2025-26 (AY 2025-2026) |
| **Type** | Core |
| **Program(s)** | B.Tech ICT, B.Tech ICT+CS |
| **Year / Semester in Program** | 2nd Year, Semester III |
| **Course Format** | 3 hours lecture + 2 hours lab every week |
...
| CO | Description |
|---|---|
| CO1 | Develop signals and systems concepts for modeling physical processes for different applications [P1, P12] |
| CO2 | Analyze practical systems for different inputs [P2] |
| CO3 | Design necessary filters (both analog and digital) for practical applications [P3] |
| CO4 | Compute convolution between (simple) sequences/functions, frequency response of a simple LTI system, Z-transform/Laplace transform of simple sequences/functions, the pole-zero plot and understand its implications for the system [P1, P5] |
| CO5 | Work in a group for a laboratory experiment, and present their results [P10] |
...
*Assessment method is tentative.*
...
1. Lecture Notes / Slides (provided by instructor)
...
CT204 (Signals and Systems) is a Core course for B.Tech ICT and B.Tech ICT+CS students in the 2nd Year (Semester III), offered in the Autumn 2025-26 semester at Dhirubhai Ambani University (DA-IICT), Gandhinagar.
...
| Resource | Type | Link |
|---|---|---|
| CT204_SignalsAndSystems_Autumn25-26 - Srimanta Mandal.pdf | PDF | [Download](https://ecampus.daiict.ac.in/webapp/intranet/index.jsp) |
...
| Field | Value |
|---|---|
| **Source PDF** | CT204_SignalsAndSystems_Autumn25-26 - Srimanta Mandal.pdf |
