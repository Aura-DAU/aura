---
title: "Medical Facility – Comprehensive Guide (v2)"
url: "https://www.daiict.ac.in/medical-facility"
secondary_sources:
  - "https://daiict.ac.in/sites/default/files/other-files/SOP-Healthcare-Facilities-and-Medical-Emergencies.pdf"
...
version: "v2"
gap_fixes:
  - "Gap 6 – 24x7 ambulance facility confirmed"
  - "Q192 – Empanelled hospitals with MoU"
  - "Q193 – Distance to Aashka Hospital"
  - "Q194 – 24x7 vehicle for medical emergencies"
  - "Q195 – Mediclaim insurance coverage amount"
  - "Q196 – Insurance company name"
...
DAU operates an on-campus **Medical Centre** staffed by visiting doctors and qualified nurses, providing free consultation to all students. The university also maintains MoUs with multiple hospitals and provides comprehensive insurance coverage.

---

## 1. Medical Centre

- **Location:** On campus, DAU Gandhinagar
- **Email:** medical@dau.ac.in
- **Services:** Free consultation and free medicines dispensed from the centre
...
## 7. Stress Management & Counselling Services
...
## 9. SOP for Medical Emergencies

### Step-by-Step Protocol

1. **Initial Assessment:** Student approaches on-campus nurse for primary medical assessment and initial treatment.
2. **Medical Decision:** Nurse determines whether a doctor visit is sufficient or hospital referral is needed.
3. **Emergency Transfer:** If immediate attention is required beyond on-campus facilities, nurse (in coordination with Security Supervisor) initiates ambulance services without delay.
4. **Critical Cases:** Student accompanied by nurse and/or Hostel Supervisor/Warden; receiving hospital informed in advance.
5. **Outside Nurse Hours:** Hostel Supervisor/Warden arranges first response and coordinates ambulance services.
6. **Reporting:** Security Supervisor and Hostel Supervisor report incident to Warden, Manager (Administration), and Dean (Students).
...
Examples: Electric shock, road accidents, poisoning, drug overdose, severe burns, haemorrhage, chest pain, snake/animal bite, food poisoning, asphyxia, hyperthermia, bone fractures, etc.
...
### Cashless Claims
- Present Medi-claim card at an empanelled hospital.
...
- [Medical Facility – DAU Website](https://www.daiict.ac.in/medical-facility)
...
- [Parents Page](https://daiict.ac.in/parents)
