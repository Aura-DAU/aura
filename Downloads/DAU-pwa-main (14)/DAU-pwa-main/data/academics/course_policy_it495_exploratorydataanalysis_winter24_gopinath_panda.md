...
This document presents the course syllabus, policy guidelines, and lecture breakdown for IT495 ExploratoryDataAnalysis Winter24 - Gopinath Panda.
...
1.4 Resources for working with data Data types
2Reading Data
072.1 Methods of Data Collection Import data to R from different sources
2.2 Import Data Reading Data from different formats
2.3 Reading Data Data Inspection
2.4 Understanding data Getting insights about the dataset
2.5 Representing Data Get values from specific locations
3Cleaning Data
103.1 Examining Data Operations on data
3.2 Finding Outliers Handling & removing outliers
3.3 Finding Missing values Checking missing values
3.4 Correcting Data looking for incompatibility
3.5 Transform Data Reorder, Reformat, Reshape
4Summarizing and Visualizing Data
154.1 Describe Data Identify variables, types and patterns
4.2 Summarize Data Mean, median, variance, SD, percentile
4.3 Visualize Data Histogram, {Box, QQ, Scatter }plots
4.4 Distribution of Data Measuring chance under distributions
5Fitting Data
105.1 Introduction Inspect data, specify a fit
5.2 Regression models Linear & multiple regression
5.3 Goodness of fit Curve fitting
5.4 Limitations
6Final project
6.1 Preparation Collect your own data
6.2 Presentation Perform EDA
6.3 Discussion Discuss with peer/Instructor
6.4 Communication, Submission Report submission
2
